...
def cut_and_slow_down_video(frame):
    ...
    # 좌측 영상 자르기(느린 속도)
    cut(left_input_video_path, left_output_slow, slow_start_frame_number, slow_end_frame_number, 3)
    # 우측 영상 자르기(느린 속도)
    cut(right_input_video_path, right_output_slow, slow_start_frame_number, slow_end_frame_number, 3)
